...
int main(void){
    ...
    ptrInt = &y;//Guardar la direccion de variable y en variable ptrInt
    ptrFloat = &z;//Guardar la direccion de variable z en variable ptrFloat
    ptrChar = &x;//Guardar la direccion de variable x en variable ptrChar
